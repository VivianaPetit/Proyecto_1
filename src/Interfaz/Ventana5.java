...
public class Ventana5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        inputPalabra.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        inputPalabra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inputPalabraActionPerformed(evt);
            }
        });
        panelRound1.add(inputPalabra, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 150, 40));
    ...
    private void inputPalabraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputPalabraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_inputPalabraActionPerformed
    ...
    private void panelRound3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelRound3MousePressed
        try {
            ...
            if (pattern.matcher(palabraNueva).matches() && palabraNueva.length() >= 3){
                Ventana2.listaWord.insertFinal(palabraNueva);
