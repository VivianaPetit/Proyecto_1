...
//                System.out.println("Letra: " + this.letras[i].letra);
    ...
    public AuxiliarBFS_1 bfsSearch(String word) {
    AuxiliarBFS_1 aux = new AuxiliarBFS_1();
    for (int i = 0; i < num_vertices; i++) {
...
private boolean bfsSearchFromVertex(int start, String word, AuxiliarBFS_1 aux) {
    boolean[] visited = new boolean[num_vertices];
...
private boolean bfsSearchFromVertexHelper(int vertex, String word, int index, boolean[] visited, AuxiliarBFS_1 aux) {
