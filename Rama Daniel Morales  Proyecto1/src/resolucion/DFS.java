...
public class DFS {
    ...
    private void visitarDAI(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
    ...
    private void visitarA(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
    ...
    private void visitarDAD(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
    ...
    private void visitarD(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
       if (aux.getDer() != null){
    ...
    private void visitarDBD(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
    ...
    private void visitarB(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
    ...
    private void visitarDBI(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
    ...
    private void visitarI(Nodo aux, long TiempoInicial, ListaNumeros ListaVisitados,ListaPalabras PalabrasEncontradas,String direccion,String Palabra){
       if (aux.getIzq() != null){
